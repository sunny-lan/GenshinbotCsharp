...
namespace genshinbot.algorithm
{
    ...
    public class TemplateMatch
    {
        public abstract class Template
        {
            ...
            protected Template(Mat reference)
            {
                Reference = reference;
                Filter(reference, FilteredReference);
            }

            public Mat FilteredReference { get; } = new Mat();

            /// <summary>
            /// must output binary image
            /// </summary>
            /// <param name="i"></param>
            /// <param name="o"></param>
            public abstract void Filter(InputArray i, OutputArray o);
        }
        ...
        Mat filter = new Mat();
        private readonly Mat sat =new Mat();
        ...
        public IEnumerable<Result> Match(Mat buf, TemplateSat template)
        {
